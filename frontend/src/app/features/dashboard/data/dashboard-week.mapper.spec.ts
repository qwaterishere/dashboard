...
const api: DashboardApi = {
  ...
  kpis: {
    revenue: { value: 8000, prevValue: 1200, forecast: null },
    checks: { value: 14, prevValue: 2, forecast: null },
    guests: { value: 28, prevValue: 4, forecast: null },
    avgCheck: { value: 571, prevValue: 600, forecast: null },
  },
  revenueByDay: [],
  revenueByMonth: [],
  units: [],
