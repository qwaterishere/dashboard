...
const api: DashboardApi = {
  ...
  kpis: {
    revenue: { value: 8000, prevValue: 1200, forecast: null, forecastToday: null, paceRisk: false },
    checks: { value: 14, prevValue: 2, forecast: null, forecastToday: null, paceRisk: false },
    guests: { value: 28, prevValue: 4, forecast: null, forecastToday: null, paceRisk: false },
    avgCheck: { value: 571, prevValue: 600, forecast: null, forecastToday: null, paceRisk: false },
  },
  revenueByDay: [],
  revenueByMonth: [],
  units: [],
