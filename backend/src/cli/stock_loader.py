"""CLI-загрузчик слепков остатков склада.

Админский ручной/бэкфилл-инструмент: штатный путь для потребителя —
шедулер и UI sync (run_sync_job). Инкрементален от последнего слепка;
первый запуск — бэкфилл BACKFILL_DAYS дней.
